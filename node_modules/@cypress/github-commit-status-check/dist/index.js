...
const debug = debug_1.default('@cypress/github-commit-status-check');
...
(function (GitHub) {
    ...
    function addCommitComment(options, gh) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield gh.repos.createCommitComment(ghOptions);
        });
    }
    GitHub.addCommitComment = addCommitComment;
...
function setCommitStatus(options) {
    return __awaiter(this, void 0, void 0, function* () {
        const params = auth_1.Auth.getFromEnvironment();
        const gh = auth_1.Auth.createGithubAppClient(params);
 ...
 */
function addCommitComment(options) {
    return __awaiter(this, void 0, void 0, function* () {
        const params = auth_1.Auth.getFromEnvironment();
        const gh = auth_1.Auth.createGithubAppClient(params);
        yield GitHub.addCommitComment(options, gh);
    });
}
exports.addCommitComment = addCommitComment;
