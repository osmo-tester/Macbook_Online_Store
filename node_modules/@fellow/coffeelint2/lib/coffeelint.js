(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.coffeelint = f()}})(function(){var define,module,exports;return (function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
module.exports={
...
TokenApi = (function() {
  function TokenApi(CoffeeScript, source, config1, tokensByLine, tokens1) {
    this.config = config1;
...
module.exports = LexicalLinter = (function(superClass) {
  ...
  function LexicalLinter(source, config, rules, CoffeeScript, tokens) {
...
module.exports = EmptyConstructorNeedsParens = (function() {
  ...
  EmptyConstructorNeedsParens.prototype.handleExpectedCallStart = function(isCallStart, tokenApi) {
...
module.exports = NoNestedStringInterpolation = (function() {
  ...
  NoNestedStringInterpolation.prototype.lintToken = function(token, tokenApi) {
    var block, ref, ref1, tag, tagname, tagtype;
    tag = token[0];
    ...
    ref = tag.split('_'), tagname = ref[0], tagtype = ref[1];
    if (tagtype === 'END') {
      block.pop();
      if (tagname === 'STRING') {
        block.strCount -= 1;
      ...
      block.push(tagname);
      if (tagname === 'STRING') {
        block.strCount = ((ref1 = block.strCount) != null ? ref1 : 0) + 1;
...
module.exports = NonEmptyConstructorNeedsParens = (function(superClass) {
  ...
  NonEmptyConstructorNeedsParens.prototype.handleExpectedCallStart = function(isCallStart, tokenApi) {
...
module.exports = SpaceOperators = (function() {
  ...
  SpaceOperators.prototype.lintToken = function(token, tokenApi) {
    var rest, type;
    type = token[0], rest = 2 <= token.length ? slice.call(token, 1) : [];
...
module.exports = SpacingAfterComma = (function() {
  ...
  SpacingAfterComma.prototype.isGenerated = function(token, tokenApi) {
